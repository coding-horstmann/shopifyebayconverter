(function (root, factory) {
  ...
  const DEFAULT_LISTING_TEMPLATE = {
    ...
    highlight1Text: "Sorgfältig ausgewähltes Plakatmotiv nach historischer Vorlage. Das Motiv wird als moderne Reproduktion gedruckt, nicht als Originalplakat. So kommt der Charakter alter Plakatkunst in eine alltagstaugliche Form.",
    highlight2IconUrl: "",
    highlight2Title: "Mattes Papier",
    highlight2Text: "Gedruckt auf mattem 200 g/m² Papier mit ruhiger, reflexionsarmer Oberfläche. Die stabile Papierqualität lässt Farben klar wirken und fühlt sich wertig an. Verwendet wird FSC-zertifiziertes oder vergleichbares Papier.",
    highlight3IconUrl: "",
    highlight3Title: "30 Tage Widerrufsrecht",
    highlight3Text: "Sie können Ihr Poster nach Erhalt in Ruhe ansehen und bei Bedarf zurückgeben. Für die Rückgabe gilt eine Frist von 30 Tagen. Die Rücksendekosten tragen Sie, sofern nichts anderes vereinbart ist.",
    highlight4IconUrl: "",
    highlight4Title: "Kostenloser Versand",
    highlight4Text: "Der Versand ist bereits im Preis enthalten, es fallen keine zusätzlichen Versandkosten im Checkout an. Die Produktion startet nach Zahlungseingang. Die Zustellung erfolgt in der Regel innerhalb von 3 bis 5 Werktagen.",
    highlight5IconUrl: "",
    highlight5Title: "Ohne Rahmen",
    highlight5Text: "Alle Poster werden ohne Rahmen geliefert. Dadurch können Sie Rahmenfarbe, Glas und Stil passend zu Ihrem Raum selbst wählen. Abgebildete Rahmen, Möbel und Dekoration dienen nur der Inspiration.",
    qualityTitle: "",
    qualityText: "",
    shippingTitle: "",
    shippingText: "",
